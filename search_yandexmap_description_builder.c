...
void createDescriptionGeoRoute(sc_addr object){
    ...
    routeIterator = sc_iterator3_f_a_a_new(
                object,
                sc_type_arc_pos_const_perm,
...
void describeCoordinatesPoint(sc_addr object){
    ...
    sc_addr coordinate;
    writeToResultString("\n\t\"coordinates\" : ");
    coordinatesIterator = sc_iterator5_a_a_f_a_f_new(
    ...
    if( sc_iterator5_next(coordinatesIterator)){
        ...
        coordinateIterator = sc_iterator3_f_a_a_new(
                    coordinates,
                    sc_type_arc_pos_const_perm,
                    sc_type_const | sc_type_node
                    );
...
void describeCoordinatesPolygon(sc_addr object){
    ...
    if( sc_iterator5_next(coordinatesIterator)){
        ...
        //exterior border
        writeToResultString("\n\t\t[");
        coordinateIterator = sc_iterator5_f_a_a_a_f_new(
                    coordinates,
                    sc_type_arc_pos_const_perm,
                    sc_type_const | sc_type_node,
                    sc_type_arc_pos_const_perm,
...
void describeCoordinate( sc_addr coordinate){
    ...
    wgs84TranslationIterator = sc_iterator5_f_a_a_a_f_new(
                coordinate,
                sc_type_arc_common | sc_type_const,
                sc_type_const | sc_type_node,
                sc_type_arc_pos_const_perm,
    ...
    if( sc_iterator5_next(wgs84TranslationIterator)){
        ...
        //latitude
        latitudeIterator = sc_iterator5_f_a_a_a_f_new(
                    wgs84Translation,
                    sc_type_arc_common | sc_type_const,
                    sc_type_link,
                    sc_type_arc_pos_const_perm,
        ...
        if( sc_iterator5_next(latitudeIterator)){
            ...
            writeToResultString("\n\t\t[");
            sc_memory_get_link_content(latitude,&contentStream);
        ...
        //longitude
        longitudeIterator = sc_iterator5_f_a_a_a_f_new(
                    wgs84Translation,
                    sc_type_arc_common | sc_type_const,
                    sc_type_link,
                    sc_type_arc_pos_const_perm,
        ...
        if( sc_iterator5_next(longitudeIterator)){
            ...
            sc_memory_get_link_content(longitude,&contentStream);
            contentBuffer = calloc(buferLength,sizeof(sc_char));
            sc_stream_read_data(contentStream,contentBuffer,buferLength,&contentBytesRead);
            writeToResultString(contentBuffer);
            free(contentBuffer);
...
sc_addr createDescriptionNode(sc_addr mapObject){
    sc_addr formatTuple;
    sc_addr translatedNode = sc_memory_link_new();
    sc_addr translatedNodeTuple = sc_memory_arc_new(
...
void appendDescriptionNodeToAnswer(sc_addr translatedNode, sc_addr answer){
    sc_addr arc;
    if (sc_helper_check_arc(answer, translatedNode, sc_type_arc_pos_const_perm) == SC_TRUE)
        return;
    arc = sc_memory_arc_new(sc_type_arc_pos_const_perm, answer, translatedNode);
    SYSTEM_ELEMENT(arc);
}

sc_bool checkIfMapHasBeenBuilt(sc_addr object){
    sc_iterator5 * mapIterator;
    mapIterator = sc_iterator5_f_a_a_a_f_new(
                object,
                sc_type_arc_common | sc_type_const,
                sc_type_link,
                sc_type_arc_pos_const_perm,
...
void flushStringToDescriptionNode(sc_addr descriptionNode){
    ...
    sc_memory_set_link_content(descriptionNode,stream);
    free(temp);
